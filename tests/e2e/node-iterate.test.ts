...
/**
 * Node `harness iterate` E2E (plan Task 26): the follow-up change runs the
 * same full closed loop inside the adopted Node project, the inspection
...
describe("node iterate E2E", { timeout: 90000 }, () => {
