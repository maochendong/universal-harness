...
export {
  ...
  type CoordinatorOriginNormalization,
} from "./collaboration/connection.js";
export {
...
export {
  ...
  type LedgerResequence,
  type LedgerSequenceRewrite,
} from "./collaboration/ledger-resequence.js";
export {
  acceptIntegration,
  integrationIdFor,
  planIntegrationCandidate,
  prepareIntegration,
  validateCandidateTree,
  type AcceptIntegrationInput,
  type AcceptIntegrationResult,
  type IntegrationDeps,
  type PrepareIntegrationInput,
  type PrepareIntegrationResult,
} from "./collaboration/integration.js";
export {
...
export type {
  ...
  IntegrationRecordListResult,
  IntegrationRecordReadResult,
  LeaseOutcome,
