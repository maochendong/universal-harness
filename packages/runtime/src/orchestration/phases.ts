 ...
 * delivery chain). `capture`, `impact` and `design` run while the operation
 * awaits approval of their proposals; `plan` commits mark the operation
 * `planned`;
